let r5rsRequiredProcedureNames: [String] = [
  ...
  "cdaadr", "cdadar", "cdaddr", "cddaar", "cddadr", "cdddar", "cdddr", "cddddr", "null?", "list?",
  "list", "length", "append", "reverse", "list-tail", "list-ref", "memq", "memv", "member", "assq",
  "assv", "assoc", "symbol?", "symbol->string", "string->symbol", "char?", "char=?", "char<?",
  ...
  "vector->list", "list->vector", "vector-fill!", "procedure?", "port?",
  "call-with-current-continuation", "apply", "map", "for-each", "values", "force", "eval",
