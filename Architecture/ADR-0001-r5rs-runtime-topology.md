...
`5af0ad4` (compiler-parser-derived no-native-UI import gate, descended from predecessor
...
- **Current (`5af0ad4`):** `Sources/swiftscheme/SwiftScheme.swift` is a
...
**Current post-migration evidence at `5af0ad4` (2026-08-14):** `Package.swift` now declares
...
**Current candidate validation at `5af0ad4` (2026-08-14):** with the Xcode 26.6 Swift 6.3.3
