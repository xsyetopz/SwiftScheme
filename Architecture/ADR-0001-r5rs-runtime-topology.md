...
`b2f16ac` (syntax-aware no-native-UI import gate, descended from predecessor
...
- **Current (`b2f16ac`):** `Sources/swiftscheme/SwiftScheme.swift` is a
...
**Current post-migration evidence at `b2f16ac` (2026-08-14):** `Package.swift` now declares
...
**Current candidate validation at `b2f16ac` (2026-08-14):** with the Xcode 26.6 Swift 6.3.3
