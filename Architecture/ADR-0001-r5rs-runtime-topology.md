...
`edc9eba` (compiler-parser-derived no-native-UI import gate, descended from predecessor
...
- **Current (`edc9eba`):** `Sources/swiftscheme/SwiftScheme.swift` is a
...
**Current post-migration evidence at `edc9eba` (2026-08-14):** `Package.swift` now declares
...
**Current candidate validation at `edc9eba` (2026-08-14):** with the Xcode 26.6 Swift 6.3.3
